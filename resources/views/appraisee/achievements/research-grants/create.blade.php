<div class="modal-body">
    <div class="form-group">
        ...
        <input type="text" required name="research_applied_for" class="form-control" placeholder="Research Applied For">
    </div>
    <div class="form-group">
        <label>Application Date</label>
        <input type="date" required name="application_date" class="form-control" placeholder="Application Date">
    </div>
    <div class="form-group">
        <label>Status: </label>
